    ...
    Item{
        ...
        states:[
            State {
                ...
                PropertyChanges {target: bt_third; comColor:"gray"}
                PropertyChanges {target: bt_second; comColor:"gray"}

                PropertyChanges {target:content;  comText:"😂first"}
                PropertyChanges {target:textHeader;  text:"first"}
            ...
            State {
                ...
                PropertyChanges {target: bt_first; comColor:"gray"}
                PropertyChanges {target: bt_second; comColor:"#b3b3b3"}
                PropertyChanges {target: bt_third; comColor:"gray"}

                PropertyChanges {target:content;  comText:"😎second"}
                PropertyChanges {target:textHeader;  text:"second"}
            ...
            State {
                ...
                PropertyChanges {target:content;  comText:"╰(*°▽°*)╯"}
                PropertyChanges {target:textHeader;  text:"third"}
